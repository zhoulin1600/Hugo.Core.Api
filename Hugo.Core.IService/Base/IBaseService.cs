...
namespace Hugo.Core.IService.Base
{
    /// <summary>
    /// 服务层基类接口
    /// </summary>
    ...
    public interface IBaseService<TEntity> where TEntity : class, new()
    {
        ...
        ///// <param name="entity">视图数据</param>
        ///// <returns>是否成功</returns>
        //Task<bool> Insert(VEntity entity);
        ...
        ///// <param name="entities">视图数据集合</param>
        ///// <returns>是否成功</returns>
        //Task<bool> Insert(List<VEntity> entities);
        ...
        ///// <returns>是否成功</returns>
        //Task<bool> Update(VEntity entity);
        ...
        ///// <param name="ignorecolumnsExpression">排除列表达式</param>
        ///// <returns>是否成功</returns>
        //Task<bool> Update(VEntity entity, Expression<Func<TEntity, bool>> whereExpression = null, Expression<Func<TEntity, object>> columnsExpression = null, Expression<Func<TEntity, object>> ignorecolumnsExpression = null);
        ...
        ///// <returns>视图数据</returns>
        //Task<VEntity> QueryById(object id, bool iscache = false);
        ...
        //Task<List<VEntity>> QueryById(object[] ids, bool iscache = false);
        ...
        ///// <param name="whereExpression">条件表达式</param>
        ///// <returns>数据列表</returns>
        //Task<List<VEntity>> QueryList(Expression<Func<TEntity, bool>> whereExpression);
        ...
        ///// <param name="whereString">SQL条件</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryList(string whereString);
        ...
        ///// <param name="orderFileds">排序字段（name asc, age desc）</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryList(Expression<Func<TEntity, bool>> whereExpression, string orderFileds);
        ...
        ///// <param name="isAsc">是否升序</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryList(string whereString, Expression<Func<TEntity, object>> orderExpression, bool isAsc = true);
        ...
        ///// <param name="isAsc">是否升序</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryList(Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, object>> orderExpression, bool isAsc = true);
        ...
        ///// <param name="orderFileds">排序字段（name asc, age desc）</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryList(string whereString, string orderFileds);
        ...
        ///// <param name="orderFileds">排序字段（name asc, age desc）</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryTopList(int intTop, Expression<Func<TEntity, bool>> whereExpression, string orderFileds);
        ...
        ///// <param name="isAsc">是否升序</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryTopList(int intTop, string whereString, Expression<Func<TEntity, object>> orderExpression, bool isAsc = true);
        ...
        ///// <param name="isAsc">是否升序</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryTopList(int intTop, Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, object>> orderExpression, bool isAsc = true);
        ...
        ///// <param name="orderFileds">排序字段（name asc, age desc）</param>
        ///// <returns>视图数据列表</returns>
        //Task<List<VEntity>> QueryTopList(int intTop, string whereString, string orderFileds);
        ...
        ///// <param name="pageSize">页大小</param>
        ///// <returns>视图数据列表</returns>
        //Task<PageResult<VEntity>> QueryPageList(Expression<Func<TEntity, bool>> whereExpression, string orderFileds, int pageIndex, int pageSize);
        ...
        ///// <param name="pageSize">页大小</param>
        ///// <returns>视图数据列表</returns>
        //Task<PageResult<VEntity>> QueryPageList(string whereString, Expression<Func<TEntity, object>> orderExpression, bool isAsc, int pageIndex, int pageSize);
        ...
        ///// <param name="pageSize">页大小</param>
        ///// <returns>视图数据列表</returns>
        //Task<PageResult<VEntity>> QueryPageList(Expression<Func<TEntity, bool>> whereExpression, Expression<Func<TEntity, object>> orderExpression, bool isAsc, int pageIndex, int pageSize);
        ...
        ///// <param name="pageSize">页大小</param>
        ///// <returns>视图数据列表</returns>
        //Task<PageResult<VEntity>> QueryPageList(string whereString, string orderFileds, int pageIndex, int pageSize);
